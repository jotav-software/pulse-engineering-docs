...
Baseados no protótipo `client-web/_apenas-git/prototipos/client-app-mock.html`:
...
| **Product Manager** | `produto/product-manager.md` | PRDs, priorização, definição de escopo |
