...
Ver [app-client.md](../produto/especificacao-funcional/app-client.md#35-vip--membership--pendente) e [producer-web.md](../produto/especificacao-funcional/producer-web.md).
...
- [global-business-rules.md](../produto/regras-negocio/global-business-rules.md) — fidelização no North Star
- [app-produtor.md](../produto/especificacao-funcional/app-produtor.md) — destaque VIP no Access (quando membership existir)
