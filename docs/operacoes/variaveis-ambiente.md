...
| `APPLE_CLIENT_ID` / `APPLE_CLIENT_SECRET` | Opc. | all | Sim | Opc. | Apple Developer → Sign in with Apple. Services ID atual: `com.pulse.ingressos.auth`. Return URL: `https://api.pulse.jotav.com.br/api/auth/callback/apple`. |
| `APPLE_APP_BUNDLE_IDENTIFIER` | Opc. | all | — | Opc. | Bundle do app cliente iOS: `com.pulse.ingressos`. |
...
Detalhes de rollout: [Checklist deploy facial](../produto/biometria/infra-deploy-checklist.md).
...
- [Segurança — CORS](../padroes/security.md)
- [Checklist deploy facial](../produto/biometria/infra-deploy-checklist.md)
- [Plano launch readiness](./plano-lancamento-tecnico.md) — Sentry, Upstash, R2, PII
- `backend/.env.example`
