...
|---|---|
| Índice | `/docs/` |
| Arquitetura (ADRs) | `/docs/arquitetura/` |
| Padrões (Backlog) | `/docs/padroes/` |
| Produto | `/docs/produto/` |
| Negócio (Jurídico, Comercial) | `/docs/negocio/` |
| Ops | `/docs/operacoes/` |
...
O `.railwayignore` exclui binários pesados; sobem `public/`, pastas de `docs/`, `src/`, `package.json`, `railway.toml`, `README.md`.
...
| Arquitetura | `/docs/arquitetura/` | `/admin/docs/arquitetura/` | ADRs, visão técnica |
| Padrões | `/docs/padroes/` | `/admin/docs/padroes/` | Regras de código, épicos |
...
| Negócio | `/docs/negocio/` | `/admin/docs/negocio/` | LGPD, contratos, comercial, pricing |
...
- Marca (Assets): `public/assets/`, `public/kits/`
- Docs: `docs/arquitetura/`, `docs/padroes/`, `docs/produto/`, `docs/negocio/`, `docs/operacoes/`
