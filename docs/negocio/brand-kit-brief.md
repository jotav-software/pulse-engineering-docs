...
### Fonte canônica
**Caminho:** `pulse-engineering-docs/marca/assets/`
...
```bash
cd pulse-engineering-docs && ./_apenas-git/scripts/sync-brand-assets.sh
```
...
### Logo a usar
📁 Vetor: `pulse-engineering-docs/marca/assets/svg/logo-horizontal.svg`
📁 PNG vertical: `pulse-engineering-docs/marca/assets/01-logo/pulse-logo-vertical-roxo.png`
