...
> Detalhe técnico: [engenharia/arquitetura/job-repasse.md](../../engenharia/arquitetura/job-repasse.md) · `ReleaseRetainedPayoutsUseCase`.
...
- Variáveis: `ENABLE_PAYOUT_RELEASE_JOB`, `PAYOUT_RELEASE_JOB_INTERVAL_MS` (ver [job-repasse.md](../../engenharia/arquitetura/job-repasse.md)).
...
Referência operacional: [especificação App Produtor — Access](../especificacao-funcional/app-produtor.md#37-access-check-in--implementado) · [facial/como-funciona-biometria-facial.md](../biometria/como-funciona-biometria-facial.md).
...
- [engenharia/arquitetura/payments/especificacao.md](../../engenharia/arquitetura/payments/especificacao.md) — checkout, multi-PSP, taxas
