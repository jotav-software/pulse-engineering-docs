...
| `CORS_ORIGINS` | **Prod** | URLs dos frontends + `*.pulse.app` | Ver [operacoes/variaveis-ambiente.md](../../../operacoes/variaveis-ambiente.md) |
...
Referência completa: [operacoes/variaveis-ambiente.md](../../../operacoes/variaveis-ambiente.md) e `backend/.env.example` (seção biometria facial).
...
| **Docs na raiz `docs/`** | Pasta workspace **não** versionada no git do pulse-backend; cópia oficial: `backend/docs/produto/` |
