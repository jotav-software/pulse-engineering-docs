...
const DOCS_SECTIONS = [
  { id: 'engenharia', label: 'Engenharia', description: 'Decisões, arquitetura, padrões, backlog' },
  { id: 'produto', label: 'Produto', description: 'Specs, regras de negócio, acesso, biometria' },
  { id: 'juridico', label: 'Jurídico', description: 'Contratos, LGPD, fiscal, conformidade' },
  { id: 'comercial', label: 'Comercial', description: 'Lançamento, pricing, apresentações' },
  { id: 'operacoes', label: 'Operações', description: 'Deploy, variáveis, CDN' },
];

const SECTION_IDS = new Set(DOCS_SECTIONS.map((s) => s.id));
const SKIP_DIRS = new Set(['node_modules', '.git', 'marca', '_apenas-git', 'lib']);
