...
- **Produção (Railway):** definir allowlist explícita — ver [Variáveis de ambiente — pulse-backend](../operacoes/variaveis-ambiente.md#pulse-backend-railway). Origens Railway atuais incluem client-web, pulse-producer-web e landing; incluir domínios custom quando forem para produção.
...
| L5 | `.env` local com secrets | backlog | Ops — [variaveis-ambiente.md](../operacoes/variaveis-ambiente.md) |
