...
Scripts para recriar senha ou renomear contas: `backend/scripts/setup-test-passwords.ts`, `backend/scripts/rename-test-emails.ts`, `backend/scripts/test-email-alias.ts`.
