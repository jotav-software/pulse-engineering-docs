...
**Mock HTML:** [admin-dashboard-mock.html](../../../../producer-web/prototypes/admin/admin-dashboard-mock.html) (repo `producer-web`) · Catálogo: [prototypes/README.md](../../../../prototypes/README.md)
