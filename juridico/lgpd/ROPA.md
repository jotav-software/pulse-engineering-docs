...
- **Art. 7º** — dados pessoais comuns:
  - I — consentimento; II — cumprimento de obrigação juridico/regulatória; V — execução de contrato; VI — exercício de direitos em processo; IX — legítimo interesse; X — proteção do crédito.
...
Detalhes técnicos: [`produto/biometria/lgpd-security.md`](../../produto/biometria/lgpd-security.md).
...
| Atributo | Conteúdo |
|---|---|
| **Tratamento** | Inventário em [`politica-cookies.md`](../politicas-publicas/politica-cookies.md) |
