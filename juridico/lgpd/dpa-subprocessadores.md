...
- **IX** — cumprimento de obrigação juridico/regulatória.
...
| Link DPA | `https://stripe.com/juridico/dpa` |
...
| Link DPA | `https://www.brevo.com/juridico/termsofuse/#data-processing-agreement` |
...
| Link DPA | `https://railway.app/juridico/dpa` `[CONFIRMAR URL]` |
...
| Link DPA | `https://sentry.io/juridico/dpa/` |
...
| Mecanismo | API key + `x-pulse-internal-key` + TLS (ver [`produto/biometria/lgpd-security.md`](../../produto/biometria/lgpd-security.md)) |
