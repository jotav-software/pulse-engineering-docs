...
| Antecipação não-regulamentada | Alta | **Remover do brand-kit até validação BCB** (decisão pendente — ver `juridico/proximos-passos.md`) |
...
- [ ] Press kit base: 1 deck + 1 release + 5 screenshots (assets em `marca/assets/` · kits HTML em `marca/kits/`)
