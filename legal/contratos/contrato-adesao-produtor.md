...
> ⚠️ Este documento é um **draft técnico** preparado por engenharia/produto a partir do funcionamento real da plataforma. **Deve ser revisado por advogado(a) habilitado(a) antes de qualquer publicação ou assinatura.** Itens entre `[colchetes em maiúsculas]` precisam ser preenchidos/decididos pela empresa antes da publicação.
...
4.3. **Razões da retenção**:
   ...
   - (b) cobertura de reembolsos solicitados conforme Cláusula 7 e a [Política de Reembolso](../politicas/politica-reembolso.md);
...
7.1. As regras de reembolso seguem a [Política de Reembolso](../politicas/politica-reembolso.md), em conformidade com:
...
8.1. O tratamento de dados pessoais entre as PARTES segue a [Política de Privacidade](../politicas/politica-privacidade.md) e a Lei 13.709/2018 ("LGPD").
...
8.4. **Biometria facial**: aceita-se a coleta apenas mediante consentimento expresso e específico do titular (Art. 11 LGPD), com finalidade exclusiva de identificação na portaria do evento e retenção máxima conforme [`product/facial/lgpd-security.md`](../../product/facial/lgpd-security.md).
