...
> Documento de tracking dos itens que **ainda precisam de input externo** após a passada de engenharia. Cross-reference deste arquivo com [`../ops/launch-readiness-plan.md`](../ops/launch-readiness-plan.md).
...
Levar **todos os 13 documentos da pasta `legal/`** para revisão. Pontos críticos para alertar:
...
- [ ] Substituir `[DPO_EMAIL_TBD]` e `[DPO_PHONE_TBD]` nos docs (busca: `rg "DPO_(EMAIL|PHONE)_TBD" legal/`)
...
- [ ] Stripe — `https://stripe.com/legal/dpa` ✅ pública
...
- [ ] Brevo — `https://www.brevo.com/legal/termsofuse/dpa/` ✅
...
3. Commit em branch separada com label `legal/v1.0-published`
