...
> Para a análise específica de **biometria facial**, ver [`product/facial/lgpd-security.md`](../../product/facial/lgpd-security.md), que já está em estado avançado.
...
- **Mitigantes**:
   ...
   - **PII em repouso planejada**: criptografar campos CPF/CNPJ/bancários (primitivas prontas — ver [Trilha A A7](../../ops/launch-readiness-plan.md#a7)).
...
- **Mitigantes**: ver [LGPD Biometria](../../product/facial/lgpd-security.md). Inclui AES-256-GCM, retenção limitada, audit logs.
- **Risco residual**: Baixo.
...
Template detalhado em `ops/incident-response-playbook.md` (a criar).
