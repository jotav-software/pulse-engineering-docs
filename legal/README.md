...
| [LGPD Biometria](../product/facial/lgpd-security.md) (já existente) | 🟢 Estado avançado |
...
- Backend já modela `policy_versions` (ver `product/policies/checkout-compliance.md`).
...
4. Submeter cada doc deste repositório para revisão; consolidar versão final em `legal/published/`.
