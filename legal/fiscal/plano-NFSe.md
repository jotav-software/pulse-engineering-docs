...
- **Modelo atual da Pulse**: taxa de 10% **adicionada ao preço** e paga pelo consumidor (Cl. 3.1 do Contrato de Adesão, §4 de [`especificacao.md`](../../architecture/payments/especificacao.md)).
